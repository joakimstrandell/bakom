  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="flex-row items-center gap-2 space-y-0 pb-4 border-b border-black/6 dark:border-white/6">
            ...
            <>
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  required
                  className="w-full px-3 py-2 border border-black/10 dark:border-white/10 rounded-lg text-sm resize-none bg-transparent focus:outline-none focus:ring-2 focus:ring-ring"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-black/10 dark:border-white/10 rounded-lg text-sm bg-transparent focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                </div>
                <div>
