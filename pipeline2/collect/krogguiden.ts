 ...
 *
 * Two-phase scrape:
 *   1. AJAX pagination to discover restaurant slugs
 *   2. Detail page scraping via JSON-LD for structured data
 *
 * Incremental by slug — skips restaurants already in krogguiden.json.
 * ~680 restaurants, primarily Stockholm.
 */
