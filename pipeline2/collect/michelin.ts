/** Guide Michelin collector — restaurants + hotels.
 *
 * Scrapes the Michelin Guide Sweden listing pages for both restaurants and hotels.
 * Two-pass: listing pages for discovery, detail pages for enrichment.
 * Michelin data is a snapshot — entire list is re-fetched on each run
 * (small dataset, ~120 entries total, changes annually).
 */
