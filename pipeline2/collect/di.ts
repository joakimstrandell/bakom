/** DI Weekend krogguide collector.
 *
 * Fetches the DI API (single JSON request returning all restaurants in a
 * cols/rows tabular format) and converts to pipeline2 Article format.
 *
 * This is a snapshot source — always re-fetches everything (~140 entries).
 */
