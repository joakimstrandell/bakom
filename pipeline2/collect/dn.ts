/** DN Krogkommissionen collector.
 *
 * Article discovery via RSS (public).
 * Full article content requires browser automation (Chrome MCP) since DN is paywalled.
 * Without Chrome MCP: collects title, date, ingress from public metadata.
 * With Chrome MCP: collects full article text, score, address, price class.
 *
 * Saves ALL articles — single reviews, multi-venue lists, roundups, news, editorial.
 * Single reviews get contentType "review" with venueName extracted from title.
 * Multi-venue and other articles get contentType "listing".
 */
