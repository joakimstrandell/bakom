/** JSON save/load utilities for pipeline2 data. */
...
/** Save articles to pipeline2/.data/articles/{filename} */
...
/** Load articles from pipeline2/.data/articles/{filename}. Returns null if missing. */
...
/** Save data to pipeline2/.data/{filename} (top-level, not articles/) */
...
/** Load data from pipeline2/.data/{filename}. Returns null if missing. */
